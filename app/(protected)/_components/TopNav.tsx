...
export const TopNav = () => {
  ...
  return (
    <div className="hidden lg:flex top-0 justify-between bg-white dark:bg-black border-b dark:border-gray-700  dark:text-gray-300 drop-shadow-sm px-12 py-2.5 items-center w-full">
