...
export const AdminCourtItem = (
    ...
    return (
    <div className=' flex flex-col rounded-xl h-full bg-white'>
     <div className=" bg-white pb-3 flex items-center justify-center  flex-col border-b-primary px-3 rounded-t-xl pt-6">
            ...
            <div className=" py-4 flex w-full justify-between">
                ...
                <div className=" flex flex-col items-end text-start justify-start">
                    ...
                    <p className=' font-semibold font-poppins text-sm text-gray-800'> { court.courtLocalGovernment } </p>
                </div>
            </div>  
            <div className=" py-4 flex w-full justify-between">
                <div className=" flex flex-col items-start text-start justify-start">
                ...
                <div className=" flex flex-col items-end text-start justify-start">
                    <small className=' text-xs uppercase font-semibold text-gray-500'>Tribunal</small>
                    <p className=' font-semibold font-poppins text-sm text-gray-800'> { court.tribunal } </p>
                </div>
            </div>
            <div className=" py-4 flex w-full justify-between">
                <div className=" flex flex-col items-end text-start justify-start">
        ...
        <div className="flex  w-full rounded-b-xl bg-red-300 font-poppins text-white">
            <Drawer>
                <DrawerTrigger className=' flex space-x-3 justify-center text-center py-3 self-end px-4 bg-primary rounded-b-xl w-full items-center'>
                <p>Details</p>
                ...
                <DrawerContent className=' h-[90vh]'>
                    ...
                    <AlertDialog>
                        ...
                        <AlertDialogContent>
                            <AlertDialogHeader>
                            <AlertDialogTitle>Are you sure you want to delete {`${court.courtName}`} ?</AlertDialogTitle>
                            <AlertDialogDescription>
