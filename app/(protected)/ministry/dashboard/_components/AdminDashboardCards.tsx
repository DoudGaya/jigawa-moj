...
import { cards as AdminCards } from './adminUtils'
...
const DashboardCard = ({
    ...
    return (
        <div className=" bg-white dark:bg-black dark:text-gray-300 w-full shadow-md rounded-lg flex flex-col">
            ...
            <Link href={ url } className=" rounded-b-lg flex space-x-3 justify-between px-2 text-green-900 bg-primary/5 p-1.5">
...
export const AdminDashboardCards = () => {
  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-6 w-full gap-4 mx-auto px-3 max-w-7xl'>
        {
            cards.map((single) => {
