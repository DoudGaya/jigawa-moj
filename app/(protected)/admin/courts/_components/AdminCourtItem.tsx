...
export const AdminCourtItem = (
    ...
    <div className=' flex flex-col rounded-xl bg-white'>
        ...
        <div className=" bg-primary flex justify-center text-center w-full rounded-b-xl py-3 px-4 font-poppins text-white">
            <Drawer>
                <DrawerTrigger className=' flex space-x-3 items-center'>
                <p>Details</p>
