...
export function AdminCreateCourtForm() {
  ...
  function onSubmit(values: z.infer<typeof CourtRegisterSchema>) {
    ...
    startTransition(() => {
      ...
      CourtRegistrationAction({...values, infrastructure: infrastructure})
      .then((data) => {
        setError(data.error)
     ...
     <Form {...form}>
      ...
      <fieldset className=" border  border-primary rounded-lg space-y-8 flex py-4 px-6 flex-col text-center items-center align-middle justify-center">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>Court Function </FormLabel>
              <FormControl>
              <Select 
                    ...
                    defaultValue={field.value}>
                      <SelectTrigger className="w-full">
                        <SelectValue placeholder="Court Function" />
                      </SelectTrigger>
                        <SelectContent>
                            {
                              courtsFunctions.map((emp) => {
         ...
         <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input disabled={isPending} className=" outline-green-500" placeholder="e.g Gumel" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
